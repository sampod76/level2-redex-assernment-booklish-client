...
const Navbar = () => {
  ...
  const navItems = (
    <React.Fragment>
      <Link
        to="/"
        onClick={closeMenu}
        className="block mt-4 lg:inline-block lg:mt-0 text-gray-600 mr-8"
      >
        Home
      </Link>
      <Link
      ...
      {user?.email ? (
        <>
          ...
          <Link
            ...
            className="block mt-4 lg:inline-block lg:mt-0 text-red-600 mr-8"
          >
            logout
          </Link>
        </>
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-green-400 font-bold rounded-md shadow-xl">
