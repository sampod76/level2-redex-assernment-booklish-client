...
const BookDetail = () => {
  ...
  return (
    <div className="border-2 rounded-lg flex justify-center items-center">
   <main >
   <section className=" mx-auto mt-8 p-8 bg-white shadow-md rounded-lg divide-y-2">
      ...
      <section className="block lg:flex justify-around max-w-m mx-auto mt-8 p-8 bg-white shadow-md rounded-lg my-7">
        ...
        >
          ...
          <textarea
            className="min-h-[100] border-2 outline-none rounded-xl  py-2 text-center font-mono  tex-2xl"
